...
import styles from "./PostRent.module.scss";
import { Row, Col } from "antd";

const { Option } = Select;

function Createtoyrent() {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      const response = await api.post("toy/rent", values);
            ...
            <Row gutter={16} className={styles.row}>
              ...
              <Col span={12}>
                <Form.Item
                  ...
                  label="Giá cọc"
                  rules={[
                    { required: true, message: "Vui lòng nhập giá  cọc!" },
                    {
                      type: "number",
                      min: 0.01,
                      message: "Gía cọc phải là số dương",
                    },
                  ]}
                >
                  <InputNumber
